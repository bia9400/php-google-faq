...
$array = [
    ...
    [
        ...
        "subtitleText"=>"Quando crei un nuovo Account Google, lo associamo a un paese in base a dove è stato creato. Per quanto riguarda gli account creati almeno un anno fa, usiamo il paese da cui accedi solitamente ai servizi Google, in genere i servizi in cui hai trascorso più tempo nell'ultimo anno.
...
<body>
    <nav>
        ...
        <div class="d-flex justify-content-between px-3">
            <div><img src="./img/Google_2015_logo.svg.png" alt="" width="100px"> <span><strong>Privacy e termini</strong></span></div>
        ...
        <ul class="d-flex list-unstyled ">
            <li><a class="text-decoration-none px-2" href="">Introduzione</a></li>
            <li><a class="text-decoration-none px-2" href="">Norme sulla privacy</a></li>
            <li><a class="text-decoration-none px-2" href="">Termini di servizio</a></li>
            <li><a class="text-decoration-none px-2" href="">Tecnologie</a></li>
            <li><a class="text-decoration-none px-2" href="">Domande frequenti</a></li>
